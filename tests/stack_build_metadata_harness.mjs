...
ok(html.includes("component: 'Broker'"), 'one UI build-metadata input names Broker');
ok(html.includes("component_version: '0.1.152'"), 'build-metadata input carries component version 0.1.152');
...
ok(html.includes('Skipi Broker · Stack SKIPI-2026.08-R1'), 'main header exposes the exact Stack label without Settings');
ok(html.includes('data-qa="desktop-stack-label">Skipi Broker · Stack SKIPI-2026.08-R1</div>'), 'loaded desktop main shell exposes the exact Stack label inline');
...
ok(cargo.includes('version = "0.1.152"'), 'Cargo package version is 0.1.152');
ok(lock.includes('name = "skipi-broker"\nversion = "0.1.152"'), 'Cargo lock root package version is 0.1.152');
ok(tauri.version === '0.1.152', 'Tauri component version is 0.1.152');
ok(tauri.identifier === 'app.skipi.broker', 'desktop app identity is preserved');
